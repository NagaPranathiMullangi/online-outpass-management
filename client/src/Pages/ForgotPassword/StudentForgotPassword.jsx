        ...
        <div className="fp-box">
            {
                isOtpSub ? (
                    ...
                    <form className="fp-form" onSubmit={handleSubmit}>
                        ...
                        <input type="text" name="enroll" id='enroll' className="fp-inp fp-up" placeholder='eg. Rxxxxxx' onChange={(e) => {setEnrollment(e.target.value.toUpperCase())}} required/>
                        <label htmlFor="email" className="fp-label">Enter your Email Id:</label>
                        <input type="email" name='email' id='email' className="fp-inp" placeholder='eg. rrxxxxxx@rguktrkv.ac.in' onChange={(e) => {setEmail(e.target.value)}} required/>
                        {isDetailSub &&
                            <>
                                <label htmlFor="otp" className="fp-label">Enter received OTP:</label>
                                <input type="number" name="otp" id="otp" className="fp-inp" placeholder='eg. xxxx' onChange={(e) => {setOtp(e.target.value)}} required/>
                            </>
                        }
